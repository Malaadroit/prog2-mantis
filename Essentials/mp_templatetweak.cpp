...
//  displayCoodinates(pointsArray, currentArrSize);
  ...
  shuffle(pointsArray, currentArrSize, sizeof(Coordinate), 0);
  printf("Shuffled array (seed: 0):\n  ");
  displayCoodinates(pointsArray, currentArrSize);
  shuffle(pointsArray, currentArrSize, sizeof(Coordinate), 1);
  printf("Shuffled array (seed: 1):\n  ");
  displayCoodinates(pointsArray, currentArrSize);
  shuffle(pointsArray, currentArrSize, sizeof(Coordinate), 2);
  printf("Shuffled array (seed: 2):\n  ");
  displayCoodinates(pointsArray, currentArrSize);
